  ...
  const deviceItems = [
    {
      ...
      imgSrc: `${import.meta.env.BASE_URL}devices/1.svg`,
    },
    {
      title: 'Tablet',
      description: 'StreamVibe is optimized for both Android and iOS smartphones. Download our app from the Google Play Store or the Apple App Store',
      imgSrc: `${import.meta.env.BASE_URL}devices/2.svg`,
    },
    {
      title: 'Smart TV',
      description: 'StreamVibe is optimized for both Android and iOS smartphones. Download our app from the Google Play Store or the Apple App Store',
      imgSrc: `${import.meta.env.BASE_URL}devices/3.svg`,
    },
    {
      title: 'Laptops',
      description: 'StreamVibe is optimized for both Android and iOS smartphones. Download our app from the Google Play Store or the Apple App Store',
      imgSrc: `${import.meta.env.BASE_URL}devices/4.svg`,
    },
    {
    ...
    },
    {
      title: 'VR Headsets',
      description: 'StreamVibe is optimized for both Android and iOS smartphones. Download our app from the Google Play Store or the Apple App Store',
      imgSrc: `${import.meta.env.BASE_URL}devices/5.svg`,
    },
  ]
